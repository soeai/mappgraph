...
class FingerprintGenerator(object):
    ...
    def _fit_single_batch_(self, X, y=None):
        ...
        # My log // List of fingerprints: [Fingerprint1, Fingerprint2, Fingerprint3, ...] Fingerprint = [Des1, Des2, ...]
        ...
        # My log // list of Destination object: [obj1, obj2, ....]
        ...
        # My log // {des1: fingerprint1, des2: fingerprint2, ..... }
