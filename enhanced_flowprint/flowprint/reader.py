...
class Reader(object):
    ...
    def read_csv(self, path):
        ...
        df['app'] = path
        df = df[['app', 'protocol', 'stream_id', 'time', 'length', 'source_address', 'destination_address', 'source_port', 'destination_port', 'certificate']]
    ...
    def read_tshark(self, path):
        ...
        print(result[:, [0, 3, 2, 1, 8, 4, 6, 5, 7, 9]].dtype)
